...
function operateFormatter(value, row, index) {
    var url = '/task/tables/' + $table.attr("data-table-type") + '/' + $table.attr("data-table-uuid") + '/edit/' + row.relation + '/' + row.table
    return [
...
function initTable() {
    ...
    $remove.click(function () {
        var ids = getIdSelections();
          ...
          $("#deleteConfirmation").append("<div class=\"badge bg-info text-wrap m-1\">"+data[ids[i]].category+"/"+data[ids[i]].relation+"/"+data[i].table+"</div>")
        }
